  ...
  return (
    <Router>
      <Routes>
            ...
            {/* @ts-ignore */}
            <Route path='/mainpage' element={<PrivateRoute component={<DataWrapper><VadWrapper><MainPageWakeWordProvider><MainPageWakeWordGate /><MainInsurancePage/></MainPageWakeWordProvider></VadWrapper></DataWrapper>}/>}/>
